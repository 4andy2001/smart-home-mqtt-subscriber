...
stores the most recent data.  When a TCP client connects to it, it provides the most recent data
...
from an outdoor sensor and a hallway sensor.
...
def callback_consolidated_outside(client, userdata, message):
    """Callback invoked when data from the "/sensor/consolidated/outside" is received

    When data from the "/sensor/consolidated/outside" is received it replaces the
    existing outside time, temperature, humidity, and pressure data in the sensor_mailbox.
    ...
    # print("callback_consolidated_outside: " + message.payload.decode())
    syslog.syslog("callback_consolidated__outside: " + message.payload.decode())
    consolidated_dict = json.loads(message.payload.decode())
    print("callback_consolidated_outside: ")
    print(f'time = {consolidated_dict["time"]}')
    print(f'temperature = {consolidated_dict["temperature"]}')
    print(f'pressure = {consolidated_dict["pressure"]}')
    print(f'humidity = {consolidated_dict["humidity"]}')    
    mutex.acquire()
    sensor_mailbox["time_outside"] = consolidated_dict["time"]
    sensor_mailbox["temperature_outside"] = consolidated_dict["temperature"]
    sensor_mailbox["pressure_outside"] = consolidated_dict["pressure"]    
    sensor_mailbox["humidity_outside"] = consolidated_dict["humidity"]
    mutex.release()
...
def callback_consolidated_hallway(client, userdata, message):
    """Callback invoked when data from the "/sensor/consolidated/hallway" is received

    When data from the "/sensor/consolidated/hallway" is received it replaces the
    existing hallway time, temperature, humidity, and pressure data in the sensor_mailbox.
    ...
    # print("callback_consolidated_hallway: " + message.payload.decode())
    syslog.syslog("callback_consolidated_hallway: " + message.payload.decode())
    consolidated_dict = json.loads(message.payload.decode())
    print("callback_consolidated_hallway: ")    
    print(f'time = {consolidated_dict["time"]}')
    print(f'temperature = {consolidated_dict["temperature"]}')
    print(f'pressure = {consolidated_dict["pressure"]}')
    print(f'humidity = {consolidated_dict["humidity"]}')    
    mutex.acquire()
    sensor_mailbox["time_hallway"] = consolidated_dict["time"]
    sensor_mailbox["temperature_hallway"] = consolidated_dict["temperature"]
    sensor_mailbox["pressure_hallway"] = consolidated_dict["pressure"]    
    sensor_mailbox["humidity_hallway"] = consolidated_dict["humidity"]
    mutex.release()
...
topics_and_callbacks = [("/sensor/temperature/outside", callback_temperature_outside),
                        ...
                        ("/sensor/consolidated/outside", callback_consolidated_outside),                        
                        ...
                        ("/sensor/consolidated/hallway", callback_consolidated_hallway),
